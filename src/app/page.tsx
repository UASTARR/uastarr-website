  ...
  return (
    ...
    <div className="z-20 relative flex flex-nowrap h-256 flex-col bg-local bg-cover bg-left justify-between" style={firstBg}> 
        ...
        <div className = "pl-14">
            <div className = "flex items-center">
                ...
                <h1 className =  "text-white text-8xl whitespace-nowrap font-bold flow_in_left">
                It's Just Rocket <br/> Science. 
                </h1>
            </div>
            <p className ="text-2xl text-white pl-4 flow_in_left whitespace-nowrap delay-300">Student Team for Alberta Rocketry Research, University of Alberta</p>
            {/* <!--Buttons--> */}
            <div className = "flex space-x-5 pl-3 pt-6">
              <Link href="/about-us">
                <button
        ...
        {/* <!--Info Box--> */}
        <div className="flex px-5 pb-32">
            <div className="flex justify-between w-screen px-3 py-3 bg-black bg-opacity-70 basis-1 grow"> 
              {/* <!-- Textboxes --> */}
                <div className = "flex items-center">
                    <div className="bg-green-800 h-20 w-2 rounded-full"></div>
                    <p className="text-white text-xl px-3 whitespace-nowrap fade_in">70+ students</p>
                </div>
                <div className = "flex items-center">
                    <div className="bg-green-800 h-20 w-2 rounded-full"></div>
                    <p className="text-white text-xl px-3 whitespace-nowrap fade_in delay-400">6 Sub-Teams</p>
                </div>
                <div className = "flex items-center">
                    <div className="bg-green-800 h-20 w-2 rounded-full"></div>
                    <p className="text-white text-xl px-3 whitespace-nowrap fade_in delay-800">Est. in 2018</p>
                </div>
                <div className = "flex items-center">
                    <div className="bg-green-800 h-20 w-2 rounded-full"></div>
                    <p className="text-white text-xl px-3 whitespace-nowrap fade_in delay-1200">1 rocket launched</p>
                </div>
                <div></div>
            </div>
        </div>
    ...
    <div className="z-10 relative flex flex-nowrap h-256 flex-col bg-emerald-900 bg-opacity-10 bg-local bg-cover bg-[center-10rem] justify-between">
        ...
        <div className ="pl-16">
            ...
            <div className = "pt-3">
              <Link href="/about-us">
                <button 
                        className="flow_in_left delay-150 whitespace-nowrap bg-yellow-500 hover:transition-all hover:bg-white rounded-full px-8 py-3">
        ...
        <div className ="pl-16 space-y-8">
            ...
            <div className = "flex space-x-16">
                ...
                <div>
                    ...
                    <h1 className="fade_in whitespace-nowrap text-2xl text-white pt-8">
                        Advance
                    </h1>
                    <p className= "fade_in whitespace-nowrap text-white pt-12 text-lg">
    ...
    <div className = "z-10 relative flex flex-nowrap flex-col bg-DarkBlue">
        ...
        <div className = "flex justify-center flex-none">
            ...
            <div className = "flex items-center space-x-5 overflow-hidden">
                ...
                <div>
                    ...
                    <h2 className = "text-white text-6xl pb-6 whitespace-nowrap">
                        Launch Canada
                    </h2>
                    <hr className ="w-24 h-2 pb-8"/>
                    <p className = "text-white text-lg whitespace-nowrap">
                        Launch Canada is a rocket competition designed to create <br/>
                        opportunities for amateur rocketeers from Canadian <br/>
                        universities.
                    </p>
                    {/* <!--Learn more button--> */}
                    <div className = "h-16"></div>
                    <div>
                      <a target="_blank" href="https://www.launchcanada.org" rel="noopener noreferrer">
                        <button
                ...
                {/* <!--Logo--> */}
                <Image src={launchCanadaLogo} className = "h-72 w-72" alt="Launch Canada Logo"/>
                <div className = "shrink w-20 overflow-hidden"></div>
        ...
        <div className = "pl-20 z-10">
            <h1 className = "flow_in_bottom px-3  w-72 py-3 bg-white rounded-t-2xl text-xl font-bold">
                ...
                <div className = "flex flex-col grow">
                    {/* <% for(let i = 0; i < sponsors.length; i += 2) { %>
                        ...
                        <div className = "flex overflow-hidden min-w-max">
                            <% for(let j = 0; j < 2; j++) { %>
                                <% let sponsor = sponsors[i + j]; %>
                                <% if(sponsor) { %>
                                    <div className ="shrink-0 h-28 w-80 grow bg-cover flex justify-center items-center overflow-hidden" style="background-image: url(/../static/assets/sponsor_bkgs/standardbkg.jpeg)">
                                        <img className = "w-60 max-w-fit max-h-28" src=<%= sponsor.imgref %>>
                                    </div>
                                <% } else if(j === 1) { %>
                                    <div className ="shrink-0 h-28 w-80 grow bg-cover flex justify-center items-center overflow-hidden" style="background-image: url(/../static/assets/sponsor_bkgs/standardbkg.jpeg)">
                                        <button onclick= "window.location.href = '/join'" className="whitespace-nowrap bg-yellow-500 hover:transition-all duration-200 hover:bg-white rounded-full px-6 py-3" href="/join" type="button">Want to become a sponsor?</button>    
                                    </div>
                                <% } %>
                            <% } %>
                        </div>
                        <% if(i === sponsors.length - 2 && sponsors.length % 2 === 0) { %>
                            <div className = "flex overflow-hidden min-w-max">
                                <div className ="shrink-0 h-28 w-80 grow bg-cover flex justify-center items-center overflow-hidden" style="background-image: url(/../static/assets/sponsor_bkgs/standardbkg.jpeg)">
                                    <button onclick= "window.location.href = '/join'" className="whitespace-nowrap bg-yellow-500 hover:transition-all duration-200 hover:bg-white rounded-full px-6 py-3" href="/join" type="button">Want to become a sponsor?</button>    
                                </div>
